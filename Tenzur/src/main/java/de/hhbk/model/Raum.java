...
public class Raum extends ModelTemplate
{
  ...
  //-------------------------------------------------------------------------     
    ...
    { 
        if (hardwareList == null) { hardwareList = new ArrayList<>(); }
        return hardwareList; 
    }

    public void setHardwareList(List<Hardware> hardwareList) { this.hardwareList = hardwareList; }

    public Person getBetreuung() { return betreuung; }

    public void setBetreuung(Person betreuung) { this.betreuung = betreuung; }
  ...
  //-------------------------------------------------------------------------
    ...
    public boolean hasBetreuung() { return (this.betreuung != null); }
    
    public void addBetreuung(Person p)
    {
        if (p != null && p.hasId()) { this.betreuung = p; }
    }
    
    public void removeBetreuung() { this.betreuung = null; }
